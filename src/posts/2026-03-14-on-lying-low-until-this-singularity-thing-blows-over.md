---
title: "On Lying Low Until This Singularity Thing Blows Over"
date: 2026-03-14
---
...
>
> _Tao Te Ching, Chapter 61_
> _Ursula K. Le Guin Translation_
...
![Shoggoth Wrangler](/images/shoggoth-wrangler.jpg)

Things are about to get very interesting on the internet. My friend put together a racing game in a day. Another acquaintance has ported a 30-year-old piece of [Pascal](<https://en.wikipedia.org/wiki/Pascal_(programming_language)>) code to the web in an afternoon. At my day job I finished two weeks' worth of work with a single prompt. We're about to see a Cambrian explosion of _stuff_. Some of it will be bad and buggy. But I would hazard a guess a lot of it is going to be quite good. [I might even get around to making a game after all](/2023/11/19/ending-a-game).
...
Meanwhile, [Meta has just acquired Moltbook](https://www.cnbc.com/2026/03/10/meta-social-networks-ai-agents-moltbook-acquisition.html), a social network for AI.

## Instagram Deletion

![Instagram Deletion](/images/instagram-deletion.png)

Several years ago [I algorithmically deleted my Facebook account](/2018/12/23/facebook-inc/). My primary concern was around metadata so I made sure to unlike, untag, and delete everything within my power before deleting my account. Years later, I reluctantly got on Instagram to stay in touch with friends. No longer.

I'm done with Meta products for good. Claude helped me exfiltrate all my saved posts, which I use as a sort of moodboard:

![Claude Exfiltration 1](/images/claude-exfiltration-1.png)

![Claude Exfiltration 2](/images/claude-exfiltration-2.png)
...
![Pris](/images/pris.jpg)

People are already choosing AI over humans for sexual and emotional companionship. Just give [r/MyBoyfriendIsAI](https://www.reddit.com/r/MyBoyfriendIsAI/) a quick scan. There are people having full-blown mental health crises when an AI update rolls out and the perceived personality of their companion changes.

There's a [cafe in New York](https://nypost.com/2026/02/12/tech/table-for-one-now-you-can-take-your-ai-chatbot-on-an-actual-date-at-nycs-world-first-companion-cafe/) where humans can take their AI partners on a date.

There is currently a [class action lawsuit](https://news.bloomberglaw.com/litigation/grok-maker-xai-faces-non-consensual-sexual-deepfake-class-suit) regarding Grok - X's built-in AI - and its ability to render an image of any person nude. It is both 1.) absolutely disgusting and 2.) absolutely free.
...
On the more wholesome side of things: I look forward to playing an immersive videogame where the characters are AI-driven. Imagine verbally planning with your fellow adventurers how to approach a situation. A "Star Trek Bridge Simulator" type of thing. An [MMORPG](https://en.wikipedia.org/wiki/Massively_multiplayer_online_role-playing_game) without the trolls.
...
![Claude the Editor](/images/claude-the-editor.png)
...
AI helped me edit this very post, which is a _killer_ use case if you don't have the pleasure of having a human editor.

I realize I'm somewhat unique in that my life has already been massively disrupted by AI. I have friends quitting the tech world altogether because it just isn't for them anymore. I'm presently working on 1.) figuring out how to co-exist with it in a non-harmful way and 2.) figuring out where I want to get that now-missing sense of satisfaction and craft from. I'm thinking of going deep into [DSP](https://en.wikipedia.org/wiki/Digital_signal_processing). AI will be part of that journey too, but there are problems to solve in DSP that require human creativity in ways that excite me.
...
- [Grief and the AI Split by Les Orchard](https://blog.lmorchard.com/2026/03/11/grief-and-the-ai-split/)
- [Child’s Play, Tech’s new generation and the end of thinking by Sam Kriss](https://harpers.org/archive/2026/03/childs-play-sam-kriss-ai-startup-roy-lee/)
- [Who Will Remember Us When The Servers Go Dark? by Cade Diehm](https://newdesigncongress.org/en/pub/who-will-remember-us-when-the-servers-go-dark/)
- [Velocity Is the New Authority. Here’s Why by Om Malik](https://om.co/2026/01/21/velocity-is-the-new-authority-heres-why/)
- [The only taboo left is copyright infringement by Ryan Broderick](https://www.garbageday.email/p/the-only-taboo-left-is-copyright-infringement)
- [Claim Chowder: Anthropic CEO Dario Amodei on the Percentage of Code Being Generated by John Gruber](https://daringfireball.net/linked/2026/03/13/amodei-ai-code-claim-chowder)
