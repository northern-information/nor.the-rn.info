...
![Goth Pro Shops](/images/goth-pro-shops.jpg)

I [broke up with my partner of fifteen years](/2025/05/04/on-marriage/). It has been difficult. Afterwards I got a neck piece and my knuckles done. Also snake bites. Some might call this a midlife crisis but my whole life has sorta been a crisis so... whatever. I love myself and I love how I look.

![Continuum Hack](/images/continuum-hack-ost.jpg)

We finished [Continuum Hack](https://continuumhack.com) and premiered it at several festivals and online. That film was about four years in the making.
...
![This had better be part of some grand occult process](/images/this-had-better-be-part-of-some-grand-occult-process.jpg)

On the other hand, I've produced about a dozen mixes this year which I am supremely proud of. [STUXNET](https://stuxnet.me) has also released several major arcana. There turned out to be no [They Became What They Beheld](https://tbwtb.co) which surprised me. There was, however, a [Northern Information](http://localhost:8080/music/northern-information/a-report-on-our-findings/) release which really surprised me. I also helped get several other musician's records over the line such as [This had better be part of some grand occult process](https://rgbrgbrgb.bandcamp.com/album/this-had-better-be-part-of-some-grand-occult-process).

![Blood Meridian & Moby Dick](/images/blood-meridian-moby-dick.jpg)

𝔡𝔞𝔲𝔫𝔱𝔩𝔢𝔰𝔰 𝔠𝔥𝔬𝔦𝔯, the Northern Information Discord server, was a joy. In particular the bookclub. We read [Walkaway](<https://en.wikipedia.org/wiki/Walkaway_(Doctorow_novel)>), [The Mushroom at the End of the World](https://en.wikipedia.org/wiki/The_Mushroom_at_the_End_of_the_World), and a "simultaneous read" of [Blood Meridian](https://en.wikipedia.org/wiki/Blood_Meridian) and [Moby Dick](https://en.wikipedia.org/wiki/Moby-Dick).
...
![Circular Ruin DSP](/images/cr-emblem.png)

Truth be told most of my energy is going into [Circular Ruin DSP](https://circularruindsp.com). We're building what I think to be the world's first neural network saturation plugin, among many other things. The learning curve is steeper than anything I've previously encountered but I find immense satisfaction in the work.
...
Circular Ruin DSP scratches a very particular itch I've had for several years. Truth be told my biggest grievence with the [arcologies](https://northern-information.github.io/arcologies-docs/) project is accessibility: the entry fee is a both a [norns](https://monome.org/docs/norns/) and a [grid](https://monome.org/docs/grid/) (and - optionally - an [arc](https://monome.org/docs/arc/)) which is quite steep. It favors a certain class of folk and I don't like that. (If I had a wooden nickel for everytime someone asked me if they could try it and I explained said entry fee... I'd have a lot of wooden nickels. It made me not want to talk about the project.)

Moving into the word of macOS/Win/Linux && VST/AU/AAX/CLAP makes my work wildly more accessible and democratized.

![Joseph, What Have You Done](/images/joseph-what-have-you-done.jpg)

My albums of the year in no particular order are:

- [Charlotte De Witte](https://charlottedewittemusic.bandcamp.com/album/charlotte-de-witte)
- [Joseph, What Have You Done?](https://rainymiller.bandcamp.com/album/joseph-what-have-you-done)
- [Dead Channel Sky](https://clppng.bandcamp.com/album/dead-channel-sky)
...
Circular Ruin DSP will release _at least_ Torus.
